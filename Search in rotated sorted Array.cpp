...
public:
    int search(vector<int>& nums, int target) {
        ...
        //First find the pivot: The only index where the next element will be smaller than the previous  element and then perform binarySearch for the right section of the array.
